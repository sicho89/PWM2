...
HD_PWD='/home/brian/0404/IP_Integrator/modulator_ipi/modulator_ipi.runs/modulator_ipi_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modulator_ipi_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modulator_ipi_xlconstant_0_0.tcl
