...
#
# Generated by export_simulation on Thu Apr 06 11:20:19 KST 2017
#
################################################################################
...
switch to the './counter_ip.sh' script.

./counter_ip.sh -reset_run
...
./counter_ip.sh -noclean_files

For more information on the script, please type './counter_ip.sh -help'.
