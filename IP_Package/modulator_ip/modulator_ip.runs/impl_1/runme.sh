...
HD_PWD='/home/brian/0404/IP_Package/modulator_ip/modulator_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modulator_ip_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modulator_ip_wrapper.tcl -notrace
