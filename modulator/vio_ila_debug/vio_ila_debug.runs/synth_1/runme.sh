...
HD_PWD='/home/brian/0404/modulator/modulator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modulator_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modulator_vio.tcl
