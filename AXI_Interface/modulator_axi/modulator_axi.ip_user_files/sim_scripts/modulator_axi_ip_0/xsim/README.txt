...
#
# Generated by export_simulation on Fri Apr 07 10:57:20 KST 2017
#
################################################################################
...
switch to the './modulator_axi_ip_0.sh' script.

./modulator_axi_ip_0.sh -reset_run
...
./modulator_axi_ip_0.sh -noclean_files

For more information on the script, please type './modulator_axi_ip_0.sh -help'.
