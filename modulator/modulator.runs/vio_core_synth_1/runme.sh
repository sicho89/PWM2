...
HD_PWD='/home/brian/0404/modulator/modulator.runs/vio_core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_core.tcl
