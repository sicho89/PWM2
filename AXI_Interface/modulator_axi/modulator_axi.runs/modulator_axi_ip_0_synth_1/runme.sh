...
HD_PWD='/home/brian/0404/AXI_Interface/modulator_axi/modulator_axi.runs/modulator_axi_ip_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modulator_axi_ip_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modulator_axi_ip_0.tcl
