...
HD_PWD='/home/brian/0404/IP_Package/modulator_ip/modulator_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modulator_ip_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modulator_ip_wrapper.tcl
