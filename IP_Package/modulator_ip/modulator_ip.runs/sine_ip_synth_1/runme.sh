...
HD_PWD='/home/brian/0404/IP_Package/modulator_ip/modulator_ip.runs/sine_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sine_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sine_ip.tcl
