...
#
# Generated by export_simulation on Thu Apr 06 11:17:52 KST 2017
#
################################################################################
...
switch to the './frequency_trigger_ip.sh' script.

./frequency_trigger_ip.sh -reset_run
...
./frequency_trigger_ip.sh -noclean_files

For more information on the script, please type './frequency_trigger_ip.sh -help'.
