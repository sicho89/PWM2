...
HD_PWD='/home/brian/0404/modulator/modulator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modulator_vio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modulator_vio.tcl -notrace
