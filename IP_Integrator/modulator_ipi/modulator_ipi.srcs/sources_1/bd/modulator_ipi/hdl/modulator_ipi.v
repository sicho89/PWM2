...
(* CORE_GENERATION_INFO = "modulator_ipi,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=modulator_ipi,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=4,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "modulator_ipi.hwdef" *) 
module modulator_ipi
  ...
  wire frequency_trigger_0_freq_trig;
  wire pwm_0_pwm_out;
  wire [11:0]sine_0_sine_out;
  wire sw0_1;
