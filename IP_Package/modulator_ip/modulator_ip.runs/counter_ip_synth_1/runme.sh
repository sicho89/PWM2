...
HD_PWD='/home/brian/0404/IP_Package/modulator_ip/modulator_ip.runs/counter_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_ip.tcl
