...
################################################################
# This is a generated script based on design: socius_xz_lab_ps_bd
#
...
# source socius_xz_lab_ps_bd_script.tcl
...
set design_name socius_xz_lab_ps_bd
...
proc create_hier_cell_socius_xz_io_ps { parentCell nameHier } {
  ...
  # Create instance: socius_xz_lab_ps_bd, and set properties
  set socius_xz_lab_ps_bd [ create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 socius_xz_lab_ps_bd ]
  set_property -dict [ list \
...
CONFIG.NUM_PORTS {4} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins spi_0] [get_bd_intf_pins socius_xz_lab_ps_bd/SPI_0]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins iic_1] [get_bd_intf_pins socius_xz_lab_ps_bd/IIC_1]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins uart_1] [get_bd_intf_pins socius_xz_lab_ps_bd/UART_1]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_pins ddr] [get_bd_intf_pins socius_xz_lab_ps_bd/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_pins fixed_io] [get_bd_intf_pins socius_xz_lab_ps_bd/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_SDIO_0 [get_bd_intf_pins sdio_0] [get_bd_intf_pins socius_xz_lab_ps_bd/SDIO_0]
  connect_bd_intf_net -intf_net processing_system7_0_USBIND_0 [get_bd_intf_pins usbind_0] [get_bd_intf_pins socius_xz_lab_ps_bd/USBIND_0]
  connect_bd_intf_net -intf_net socius_xz_lab_ps_bd_M_AXI_GP0 [get_bd_intf_pins socius_xz_bram_switch_bd/S00_AXI] [get_bd_intf_pins socius_xz_lab_ps_bd/M_AXI_GP0]
  ...
  connect_bd_net -net socius_xz_lab_ps_bd_FCLK_CLK0 [get_bd_pins fclk_clk0] [get_bd_pins socius_xz_lab_ps_bd/FCLK_CLK0]
  connect_bd_net -net socius_xz_lab_ps_bd_FCLK_CLK1 [get_bd_pins fclk_clk1] [get_bd_pins socius_xz_bram_switch_bd/S00_ACLK] [get_bd_pins socius_xz_lab_ps_bd/FCLK_CLK1] [get_bd_pins socius_xz_lab_ps_bd/M_AXI_GP0_ACLK] [get_bd_pins socius_xz_lab_ps_bd/S_AXI_HP0_ACLK]
  connect_bd_net -net socius_xz_lab_ps_bd_FCLK_CLK2 [get_bd_pins fclk_clk2] [get_bd_pins socius_xz_lab_ps_bd/FCLK_CLK2]
  connect_bd_net -net socius_xz_lab_ps_bd_FCLK_CLK3 [get_bd_pins fclk_clk3] [get_bd_pins socius_xz_lab_ps_bd/FCLK_CLK3]
  connect_bd_net -net socius_xz_lab_ps_bd_FCLK_RESET0_N [get_bd_pins fclk_reset0_n] [get_bd_pins socius_xz_bram_switch_bd/M01_ARESETN] [get_bd_pins socius_xz_lab_ps_bd/FCLK_RESET0_N]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins socius_xz_lab_ps_bd/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
...
preplace inst socius_xz_lab_ps_bd -pg 1 -lvl 2 -y 170 -defaultsOSRD
...
preplace netloc socius_xz_lab_ps_bd_M_AXI_GP0 1 2 1 640
preplace netloc pl_int_mid_1 1 0 1 N
preplace netloc socius_xz_lab_ps_bd_FCLK_CLK0 1 2 2 NJ 190 NJ
preplace netloc socius_xz_lab_ps_bd_FCLK_CLK1 1 1 3 210 350 660 210 NJ
preplace netloc processing_system7_0_USBIND_0 1 2 2 NJ 160 NJ
preplace netloc xlconcat_0_dout 1 1 1 200
preplace netloc socius_xz_lab_ps_bd_FCLK_CLK2 1 2 2 NJ 220 NJ
preplace netloc pl_int_soc_1 1 0 1 N
preplace netloc processing_system7_0_FIXED_IO 1 2 2 NJ 60 NJ
preplace netloc socius_xz_lab_ps_bd_FCLK_CLK3 1 2 2 NJ 240 NJ
...
preplace netloc socius_xz_lab_ps_bd_FCLK_RESET0_N 1 2 2 630 410 NJ
levelinfo -pg 1 0 110 420 790 930 -top 0 -bot 430
",
}
...
CONFIG.MASTER_TYPE {BRAM_CTRL} \
  ...
  connect_bd_net -net socius_xz_lab_ps_bd_FCLK_CLK0 [get_bd_ports pl_clk0] [get_bd_pins socius_xz_io_ps/fclk_clk0]
  connect_bd_net -net socius_xz_lab_ps_bd_FCLK_CLK1 [get_bd_ports pl_clk1] [get_bd_pins socius_xz_io_ps/fclk_clk1]
  connect_bd_net -net socius_xz_lab_ps_bd_FCLK_CLK2 [get_bd_ports pl_clk2] [get_bd_pins socius_xz_io_ps/fclk_clk2]
  connect_bd_net -net socius_xz_lab_ps_bd_FCLK_CLK3 [get_bd_ports pl_clk3] [get_bd_pins socius_xz_io_ps/fclk_clk3]
  connect_bd_net -net socius_xz_lab_ps_bd_FCLK_RESET0_N [get_bd_ports pl_reset_n] [get_bd_pins socius_xz_io_ps/fclk_reset0_n]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x40030000 [get_bd_addr_spaces socius_xz_io_ps/socius_xz_lab_ps_bd/Data] [get_bd_addr_segs socius_xz_io_ps/socius_xz_bram_switch_bd/socius_xz_bram_if_pl_bot/S_AXI/Mem0] SEG_socius_xz_bram_if_pl_bot_Mem0
  create_bd_addr_seg -range 0x10000 -offset 0x40010000 [get_bd_addr_spaces socius_xz_io_ps/socius_xz_lab_ps_bd/Data] [get_bd_addr_segs socius_xz_io_ps/socius_xz_bram_switch_bd/socius_xz_bram_if_pl_mid/S_AXI/Mem0] SEG_socius_xz_bram_if_pl_mid_Mem0
  create_bd_addr_seg -range 0x10000 -offset 0x40000000 [get_bd_addr_spaces socius_xz_io_ps/socius_xz_lab_ps_bd/Data] [get_bd_addr_segs socius_xz_io_ps/socius_xz_bram_switch_bd/socius_xz_bram_if_pl_soc/S_AXI/Mem0] SEG_socius_xz_bram_if_pl_soc_Mem0
  create_bd_addr_seg -range 0x10000 -offset 0x40020000 [get_bd_addr_spaces socius_xz_io_ps/socius_xz_lab_ps_bd/Data] [get_bd_addr_segs socius_xz_io_ps/socius_xz_bram_switch_bd/socius_xz_bram_if_pl_top/S_AXI/Mem0] SEG_socius_xz_bram_if_pl_top_Mem0
...
preplace netloc socius_xz_lab_ps_bd_FCLK_CLK0 1 1 1 NJ
preplace netloc In0_1 1 0 1 NJ
preplace netloc socius_xz_lab_ps_bd_FCLK_CLK1 1 1 1 NJ
preplace netloc processing_system7_0_USBIND_0 1 1 1 NJ
preplace netloc socius_xz_lab_ps_bd_FCLK_CLK2 1 1 1 NJ
preplace netloc In3_1 1 0 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 1 NJ
preplace netloc socius_xz_lab_ps_bd_FCLK_CLK3 1 1 1 NJ
...
preplace netloc socius_xz_lab_ps_bd_FCLK_RESET0_N 1 1 1 NJ
